...
const Erkoispuoli = () => {
    ...
    const [selectedField, setSelectedField] = useState(400);
            ...
            .then(response => {
                ...
                if (Array.isArray(responseData)) {
                    const cleanedData = responseData.map(row => ({
                        ...
                        "StatusErikoispuoli": row["StatusErikoispuoli"] ?? 'Ei aloitettu',
                        "total_madeErikoispuoli": row["total_madeErikoispuoli"] ?? '-',
                        "section": osasto,
    ...
    const handleRowClick = (row) => { 
        navigate('/StartWork', { state: {...row, section: "Erikoispuoli" }});
    };
    ...
    const handleHistory = (row) => {
        ...
        axios.post(`${API_URL}/api/fetch_history`, { id: selectedKey, section: "Erikoispuoli" }, {
            headers: {
    ...
    const getStatusColor = (StatusErikoispuoli) => {
        switch (StatusErikoispuoli) {
            case 'Aloitettu':
                            ...
                            {filteredData.length > 0 ? (
                                filteredData.map((row, index) => (
                                    <TableRow
                                        ...
                                        sx={{
                                            cursor: 'pointer',
                                            bgcolor: getStatusColor(row["StatusErikoispuoli"]),
                                            '&:hover': {
                                    ...
                                    >
                                        ...
                                        <TableCell sx={{ padding: '6px 10px', fontSize: '0.875rem' }} >{row["total_madeErikoispuoli"]}</TableCell>
                                        <TableCell sx={{ padding: '6px 10px', fontSize: '0.875rem' }} >{row["StatusErikoispuoli"]}</TableCell>
                                        <TableCell>
                    ...
                    {isEditing && selectedTask && (
                        <Box sx={{ mt: 3 }}>
                            ...
                            <FormControl fullWidth sx={{ mt: 2 }}>
                                ...
                                >
                                    {phases
                                        .filter(phase => phase.id === "Erikoispuoli") // ✅ Filter for "Leikkaus" phases
                                        .map((phase, index) => (
