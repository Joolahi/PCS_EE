...
const Pakkaus = () => {
            ...
            .then(response => {
                ...
                if (Array.isArray(responseData)) {
                    const cleanedData = responseData.map(row => ({
                        ...
                        "StatusPakkaus": row["StatusPakkaus"] ?? 'Ei aloitettu',
                        "total_madePakkaus": row["total_madePakkaus"] ?? '-',
                        "section": osasto,
    ...
    const handleRowClick = (row) => {
        navigate('/StartWork', { state: {...row, section: "Pakkaus" }});
    };
    ...
    const handleHistory = (row) => {
        ...
        axios.post(`${API_URL}/api/fetch_history`, { id: selectedKey, section: "Pakkaus" }, {
            headers: {
    ...
    const getStatusColor = (StatusPakkaus) => {
        switch (StatusPakkaus) {
            case 'Aloitettu':
                                ...
                                {filteredData.length > 0 ? (
                                    filteredData.map((row, index) => (
                                        <TableRow
                                            ...
                                            sx={{
                                                cursor: 'pointer',
                                                bgcolor: getStatusColor(row["StatusPakkaus"]),
                                                '&:hover': {
                                        ...
                                        >
                                            ...
                                            <TableCell sx={{ padding: '6px 10px', fontSize: '0.875rem' }} >{row["total_madePakkaus"]}</TableCell>
                                            <TableCell sx={{ padding: '6px 10px', fontSize: '0.875rem' }} >{row["StatusPakkaus"]}</TableCell>
                                            <TableCell>
